...
Objects that you can edit and get things overidden are:
    ...
    - Products.csvreplicata.tests.user_testcase:
    ...
    - Products.csvreplicata.tests.user_utils:

        utilities functions to register as a global in tests

    - Products.csvreplicata.tests.user_globals:
...
try:from Products.csvreplicata.tests.user_testcase import setUp
except:pass
try:from Products.csvreplicata.tests.user_testcase import tearDown
except:pass
...
try:
    ...
    try:
        from Products.csvreplicata.tests.user_testcase import DocTestCase
    except:pass
    #       from Testing import ZopeTestCase as ztc
